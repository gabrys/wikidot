 ...
 */
class DB_OzoneSessionPeerBase extends BaseDBPeer {
	...
	protected function internalInit(){
		...
		$this->fieldTypes = array( 'session_id' => 'varchar(60)',  'started' => 'timestamp',  'last_accessed' => 'timestamp',  'ip_address' => 'varchar(90)',  'check_ip' => 'boolean',  'infinite' => 'boolean',  'user_id' => 'int',  'serialized_datablock' => 'bytea');
